<div>
    ...
    <x-filament::field-wrapper.label class="btn btn-sm btn-outline-success d-block" for="Interested{{ $post_id }}">
    ...
    <x-filament::field-wrapper.label class="btn btn-outline-light btn-sm mb-0" for="articleup{{ $post_id }}">
        <i
